...
const Nomination = (props) => {
    ...
    const [nominationCiscoAcademyYear, setNominationCiscoAcademyYear] =
        useState(1998);
    ...
    const nominationNameLabel = nominationInstructor
        ? '*A jelölt neve*'
        : 'A jelölt intézmény neve*';
    const setNominationCiscoAcademyYearLabel = nominationInstructor
        ? 'Mikortól akadémiai oktató a jelölted?*'
        : 'Mikortól Cisco Akadémia a jelölt intézmény?*';
    ...
    return (
        <Section id="jeloles" container placeholder>
            <Title>
                Jelölés NetAcad Oktatásért
                <span className="text-uppercase"> DÍJRA</span>
            </Title>
            ...
            {nominationFormEnabled ? (
                <>
                    <form className="reg-form" onSubmit={onSubmit}>
                        <Text center>
                            <StructuredText data={nominationParagraph} />
                        </Text>
                        ...
                        {nominationInstructor ? (
                            <>
                                ...
                                <div className="form-check mb-4 mt-4">
                                    ...
                                    >
                                        NetAcad Oktatásért díj a szakképzésben
                                        végzett kiemelkedő munkáért
                                    </label>
                                </div>
                                <div className="form-check mb-4 mt-4">
                                    <input
                                    ...
                                    >
                                        NetAcad Oktatásért díj a felsőoktatásban
                                        végzett kiemelkedő munkáért
                                    </label>
                                </div>
                                ...
                                <label
                                    ...
                                    htmlFor="nomination-name-field"
                                >
                                    {nominationNameLabel}
                                </label>
                                <input
                                    id="nomination-name-field"
                                    className="form-control"
                                ...
                                <label
                                    className="form-label"
                                    htmlFor="nomination-email-field"
                                >
                                    A jelölt e-mail címe*
                                </label>
                                <input
                                    id="nomination-email-field"
                                    className={`form-control ${
                                        error === 'email' ? 'is-invalid' : ''
                                    }`}
                                    value={nominationEmail}
                                    onChange={(e) =>
                                        setNominationEmail(e.target.value)
                                    }
                                    autoComplete="email"
                                    required
                                />
                                ...
                                <label
                                    className="form-label"
                                    htmlFor="nomination-phone-field"
                                >
                                    A jelölt telefonszáma
                                </label>
                                <input
                                    id="nomination-phone-field"
                                    className="form-control"
                                    value={nominationPhone}
                                    onChange={(e) =>
                                        setNominationPhone(e.target.value)
                                    }
                                    autoComplete="tel"
                                />
                                ...
                                <input
                                    ...
                                    className="form-control"
                                    value={nominationWorkplace}
                                    onChange={(e) =>
                                        setNominationWorkplace(e.target.value)
                                    }
                                    autoComplete="organization"
                                    required
                                />
                        ...
                        <label
                            className="form-label"
                            htmlFor="nomination-city-field"
                        >
                            Település*
                        </label>
                        <input
                            id="nomination-city-field"
                            className="form-control"
                            value={nominationCity}
                            onChange={(e) => setNominationCity(e.target.value)}
                            autoComplete="address-level2"
                            required
                        />
                        ...
                        >
                            {setNominationCiscoAcademyYearLabel}
                        </label>
                        <select
                            id="cisco-academy-teacher-since"
                            className="form-select"
                            value={nominationCiscoAcademyYear}
                            onChange={(e) =>
                                setNominationCiscoAcademyYear(e.target.value)
                            }
                            required
                        >
                        ...
                        <label
                            className="form-label mt-3"
                            htmlFor="nomination-justification-field"
                        >
                            A jelölés rövid indoklása (maximum 300 karakter)*
                        </label>
                        <textarea
                            id="nomination-justification-field"
                            className="form-control"
                            value={nominationReason}
                            placeholder="Kérjük röviden indokold, hogy mi alapján tartod a jelöltet méltónak a díjra!"
                            onChange={(e) =>
                                setNominationReason(e.target.value)
                            }
                            autoComplete="address-level2"
                            required
                        />
                        ...
                        <Alert variant="danger" show={error === 'other'}>
                            Ismeretlen hiba történt a jelölés során. Kérlek,
                            próbáld újra később.
                        </Alert>
                ...
                <>
                    <Title subtitle>
                        A jelölési időszak lezárult.
                        <br />
                        Köszönjük a jelöléseket!
                    </Title>
                </>
            )}
        </Section>
